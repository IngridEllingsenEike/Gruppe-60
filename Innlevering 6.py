...
with open('/Users/theadyrseth/Desktop/Koding/DAT120/temperatur_trykk_met_samme_rune_time_datasett.csv.txt', mode='r') as file:
...
with open('/Users/theadyrseth/Desktop/Koding/DAT120/trykk_og_temperaturlogg_rune_time.csv.txt', mode='r') as file:
    reader = csv.reader(file, delimiter=';')
    header = next(reader)  # Hopp over header-linjen
    for row in reader:
